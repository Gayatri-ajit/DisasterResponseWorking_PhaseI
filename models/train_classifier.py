...
current = os.path.dirname(os.path.realpath('D:\CSE\DisasterResponseProject-main\models'))
...
def load_data(database_filepath):
    ...
    '''
    engine = create_engine('sqlite:///D:\CSE\DisasterResponseProject-main\data\DisasterResponse.db')
