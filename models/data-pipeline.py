...
def load_data(messages_filepath, categories_filepath):
    messages = pd.read_csv('D:\CSE\DisasterResponseProject-main\data\disaster_messages.csv')
    categories = pd.read_csv('D:\CSE\DisasterResponseProject-main\data\disaster_categories.csv')
    #merge datasets
...
def save_data(df, database_filename):
    engine = create_engine('sqlite:///criticare.db')
